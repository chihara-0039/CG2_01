...
('現在地と今後','機能を増やす段階から、遊びへ結び付けて磨く段階へ進めています。',[('h','現在できていること'),('b',['BaseSceneとSceneManagerによるタイトル／ゲーム／クリアのシーン管理','移動・ジャンプ・カメラ・落下復帰・スター取得判定','スター取得演出、COURSE CLEAR表示、次シーンまで継続する花火','外部ステージ読込、天候、照明、GPUパーティクル、ポストエフェクト']),('h','次に強化すること'),('b',['ステージ攻略のバリエーションとギミック追加','スター取得からクリアまでのカメラワーク調整','操作感、当たり判定、カメラ挙動の継続調整','短時間で作品の魅力が伝わる企業向けデモ導線'])])]
